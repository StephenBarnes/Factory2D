...
* A 20x14 editable Canvas 2D grid with procedural sand, falling stone, magnetic metal, directional magnets, circuit conduits, and occupancy sensor, charge sensor, inverter, combiner, rectifier, multiplier, and subtractor runes.
...
* `tests/circuit.test.ts` — Instant welded-network propagation, occupancy and charge sensor directionality, isolated gate networks and delay, combiner, multiplier, and subtractor truth tables, disconnection, and moving-charge tests.
