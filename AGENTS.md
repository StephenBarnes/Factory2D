...
* `src/ui/component-palette.ts` — Definition-driven sandbox and priced puzzle component-palette construction with visible-order keyboard-shortcut assignment.
...
* `tests/component-palette.test.ts` — Sandbox and puzzle visible-order shortcut assignment tests.
