...
* `e2e/app-lifecycle.spec.ts` — Playwright lifecycle coverage for routing, solution persistence/actions, reloads, malformed storage, puzzle reports, export dropup availability and downloads, and narrow-screen overflow.
