...
* Directional pistons use one retracted tile and separate welded base/arm tiles while extended. +1 extends and pushes complete obstruction chains; -1 retracts and pulls a head-welded body; 0 holds state. The head weld follows the arm, while the base retains its other three welds and circuit connections.
