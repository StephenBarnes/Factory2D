...
* `src/main.ts` — Browser entry point, screen navigation, saved-solution workshop sessions and persistence, puzzle victory consumption and progress persistence, input handling, build tools, bounded pan/zoom controls, overlay-aware viewport insets, inspector coordination, and animation loop.
