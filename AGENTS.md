...
* `src/simulation/board-export.ts` — Deterministic compact ASCII tile-and-weld-grid JSON serialization with explicit bounded dimensions and strict validation/deserialization for sharing board, furnace, and puzzle-result state.
