# Archived performance investigation and optimization history

**Historical evidence, not current guidance.** Archived on 2026-09-16. The original profiling date and individual update dates were not recorded here. Measurements, source line references, conclusions, and “next task” statements below describe different earlier revisions and may be obsolete.

Use [performance-todos.md](performance-todos.md) for current measurements, unresolved work, and priorities. The original report and Updates 1–14 are preserved unchanged below; do not append new updates to this archive.
