...
* In the sandbox's puzzle properties modal, for the "player-placeable components" group, group and order the possible tiles in the same way the palette does - grouped into raw materials, mechanisms, etc. And add buttons to check or uncheck all tiles in each group.
