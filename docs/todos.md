...
* Modify splitter, welder, laser splitter, dismantler, and riveter: only split/weld on +1 signal, instead of being enabled by default and disabling on -1. May break some current reference solutions.
