...
* Bug: after entering a rune array (with enter key) and then exiting, camera is set too zoomed-in and panned to top-left. We should probably save a stack of camera views and pop from that when exiting a rune array.
