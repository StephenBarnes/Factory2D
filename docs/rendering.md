...
Bevel lighting reuses diagonally translated outline strokes clipped to the original body. The stroke radius covers the full diagonal translation (`Math.SQRT2` times its per-axis offset), preventing unlit fill crescents at convex corners and concave weld fillets.
